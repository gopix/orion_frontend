...
//   // Each entry: { id, check_id, check_code, check_name, description,
//   //               category, default_priority, wcag_reference, pdfua_reference,
//   //               remediation_guidance, is_active, orgId, orgName }
...
//   // Organisation tab: run-checks state (kept for "Proceed" workflow on cards)
...
//   // Scroll org section into view after clone
...
//   // Clone: adds selected checks as individual entries in org section,
//   // then switches to organization tab and scrolls to the new entries.
...
//     );
//     const projectId = org?.project_id ?? org?.projectId ?? String(selectedOrgId);

//     setCloning(true);
//     setCloneError("");
//     try {
//       const response = await cloneMasterTemplate(Number(selectedOrgId), projectId);
//       if (response.ok) {
...
//         setBatchSelected([]);
//         setSelectedOrgId("");
//         // Switch to organisation tab, then scroll to entries
...
//           {/* ══════════════════════════════════════════════
//               ORGANISATION TAB — cloned entries table
//           ══════════════════════════════════════════════ */}
//           {activeNav === "organization" && (
...
//                   <p className="tp-section-sub">Cloned entries from Master Template — fully editable</p>
//                 </div>
//               </div>
...
//                   <p className="tp-org-empty-title">No cloned entries yet</p>
//                   <p className="tp-org-empty-sub">Go to Master Template → Clone to add entries here.</p>
//                 </div>
//               ) : (
...
//                 Select the checks you want to clone, then choose the target organization.
//               </p>
...
//               </div>
//               <div style={{ maxHeight: "40vh", overflowY: "auto", borderTop: "1px solid #dbeafe" }}>
...
//       {/* ════════════════════════════════════════════════════
//           ORG ENTRY EDIT MODAL — full CRUD for a single cloned check
//       ════════════════════════════════════════════════════ */}
