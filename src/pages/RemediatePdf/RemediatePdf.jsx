...
//                   </div>
//                   {rawResult && parsed && (
//                     <div className={`rp-overall-badge ${parsed.issues_remaining > 0 ? "badge-warn" : "badge-pass"}`}>
//                       {parsed.issues_remaining > 0 ? "⚠️ PARTIAL" : "✅ FIXED"}
//                     </div>
//                   )}
//                 </div>
...
//                           <div className="rp-dic-file-icon"><span>PDF</span></div>
//                           <div className="rp-dic-file-meta">
//                             <span className="rp-dic-filename">{pdfFile?.name ?? "—"}</span>
...
//                           </div>
//                         </div>
//                         <div className={`rp-dic-verdict ${parsed.issues_remaining > 0 ? "verdict-warn" : "verdict-pass"}`}>
//                           <span className="rp-dic-verdict-icon">{parsed.issues_remaining > 0 ? "⚠" : "✓"}</span>
//                           <div>
//                             <span className="rp-dic-verdict-label">
//                               {parsed.issues_remaining > 0 ? "PARTIAL" : "FIXED"}
//                             </span>
//                             <span className="rp-dic-verdict-sub">
//                               {parsed.issues_fixed ?? 0} of {parsed.issues_detected ?? 0} issues resolved
//                             </span>
//                           </div>
//                         </div>
//                       </div>
...
//                                 <span className="rp-dic-res-label">Auto-fixable</span>
//                               </div>
//                             </div>
...
//                                 <span className="rp-dic-res-label">Fix rate</span>
//                               </div>
//                             </div>
//                           </div>
//                         </div>
...
//                       {(parsed.download_url || parsed.report_url) && (
...
//                           <div>
//                             <h3 className="rp-status-title">Remediation Status</h3>
//                             <p className="rp-status-desc">
//                               Poll the status of your remediation job using the job ID returned above.
//                             </p>
//                           </div>
//                           <button
...
//                             <div className="rp-status-result-row">
//                               <div className="rp-status-kv">
//                                 <span className="rp-status-key">Response Code</span>
//                                 <span className="rp-status-val">{statusData.response_code ?? "—"}</span>
//                               </div>
//                               <div className="rp-status-kv">
//                                 <span className="rp-status-key">Message</span>
//                                 <span className="rp-status-val">{statusData.message ?? "—"}</span>
//                               </div>
//                               {statusData.data && (
//                                 <div className="rp-status-kv">
//                                   <span className="rp-status-key">Status Data</span>
//                                   <span className="rp-status-val rp-status-data">{typeof statusData.data === "string" ? statusData.data : JSON.stringify(statusData.data)}</span>
//                                 </div>
//                               )}
//                             </div>
//                             {statusData.errors && statusData.errors.length > 0 && (
//                               <div className="rp-status-errors">
//                                 <p className="rp-status-errors-label">Errors</p>
//                                 {statusData.errors.map((err, i) => (
//                                   <div key={i} className="rp-status-error-item">⚠ {err}</div>
//                                 ))}
//                               </div>
//                             )}
//                           </div>
