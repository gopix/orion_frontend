...
//                         onClick={() => setShowDetailedResults(true)}
//                       >
//                         <span className="rp-btn-icon">📊</span> Show Results Summary
//                       </button>
//                       <button
//                         className="rp-action-btn rp-action-primary"
//                         onClick={handleGetReport}
...
//                     {/* Download and Report URLs */}
//                     {rawResult.data && (
//                       <div className="rp-urls-info-block">
//                         <h4 className="rp-block-title">Resources</h4>
//                         {rawResult.data.download_url && (
//                           <div className="rp-url-item">
//                             <span className="rp-url-label">Download URL</span>
//                             <code className="rp-url-code">{rawResult.data.download_url.substring(0, 80)}...</code>
//                           </div>
//                         )}
//                         {rawResult.data.report_url && (
//                           <div className="rp-url-item">
//                             <span className="rp-url-label">Report URL</span>
//                             <code className="rp-url-code">{rawResult.data.report_url.substring(0, 80)}...</code>
//                           </div>
//                         )}
//                       </div>
//                     )}
...
//                     {reportData.data && reportData.data.validation_report && (
//                       <div className="rp-report-section-block">
//                         <div className="rp-report-section-header">
//                           <h3 className="rp-report-section-title">Validation Report</h3>
//                         </div>
//                         <div className="rp-report-section-content">
//                           {typeof reportData.data.validation_report === 'string' ? (
//                             <p className="rp-report-text">{reportData.data.validation_report}</p>
//                           ) : (
//                             <div className="rp-report-json-block">
//                               <pre>{JSON.stringify(reportData.data.validation_report, null, 2)}</pre>
//                             </div>
//                           )}
//                         </div>
//                       </div>
...
//                     {reportData.data && reportData.data.remediation_details && (
//                       <div className="rp-report-section-block">
//                         <div className="rp-report-section-header">
//                           <h3 className="rp-report-section-title">Remediation Details</h3>
//                         </div>
//                         <div className="rp-report-section-content">
//                           {typeof reportData.data.remediation_details === 'string' ? (
//                             <p className="rp-report-text">{reportData.data.remediation_details}</p>
//                           ) : (
//                             <div className="rp-report-json-block">
//                               <pre>{JSON.stringify(reportData.data.remediation_details, null, 2)}</pre>
//                             </div>
//                           )}
//                         </div>
//                       </div>
...
//                     {/* Re-validation Report Section */}
//                     {reportData.data && reportData.data.re_validation_report && (
//                       <div className="rp-report-section-block">
//                         <div className="rp-report-section-header">
//                           <h3 className="rp-report-section-title">Re-validation Report</h3>
//                         </div>
//                         <div className="rp-report-section-content">
//                           {typeof reportData.data.re_validation_report === 'string' ? (
//                             <p className="rp-report-text">{reportData.data.re_validation_report}</p>
//                           ) : (
//                             <div className="rp-report-json-block">
//                               <pre>{JSON.stringify(reportData.data.re_validation_report, null, 2)}</pre>
//                             </div>
//                           )}
//                         </div>
//                       </div>
...
//                     {statusData && !statusLoading && (
//                       <div className="rp-status-result">
//                         <p className="rp-result-block-label">Job Status Details</p>
...
//                       <h3 className="rp-results-title">Step 3: Detailed Results</h3>
//                       <p className="rp-results-desc">
//                         Your PDF remediation is complete. View comprehensive results and download the remediated file.
//                       </p>
//                     </div>
...
//                         onClick={() => setShowDetailedResults(true)}
//                       >
//                         <span className="rp-btn-icon">📊</span> Show Detailed Results
//                       </button>
//                       {jobId && (
//                         <button
//                           className="rp-action-btn rp-action-secondary"
...
//                     <div className="rp-results-header">
//                       <div>
//                         <h3 className="rp-results-title">Detailed Remediation Results</h3>
//                         <p className="rp-results-desc">
//                           Complete analysis and summary of the PDF remediation process
//                         </p>
//                       </div>
//                       <button
//                         className="rp-close-results-btn"
//                         onClick={() => setShowDetailedResults(false)}
//                         title="Hide detailed results"
//                       >
//                         ✕
//                       </button>
//                     </div>
...
//                           <span className="rp-summary-label">Issues Detected</span>
//                           <span className="rp-summary-value">{parsed.issues_detected || 0}</span>
//                         </div>
//                         <div className="rp-summary-card">
//                           <span className="rp-summary-label">Issues Fixed</span>
//                           <span className="rp-summary-value success">{parsed.issues_fixed || 0}</span>
//                         </div>
//                         <div className="rp-summary-card">
//                           <span className="rp-summary-label">Issues Remaining</span>
//                           <span className="rp-summary-value warning">{parsed.issues_remaining || 0}</span>
//                         </div>
//                         <div className="rp-summary-card">
//                           <span className="rp-summary-label">Auto-Fixable Count</span>
//                           <span className="rp-summary-value">{parsed.auto_fixable_count || 0}</span>
//                         </div>
//                       </div>
//                     )}

//                     {/* ── Full API Response ── */}
//                     <div className="rp-api-response-section">
//                       <h4 className="rp-response-title">Complete API Response</h4>
//                       <div className="rp-api-response-container">
//                         <pre className="rp-api-response-code">
...
//                         onClick={() => setShowDetailedResults(false)}
//                       >
//                         <span className="rp-btn-icon">✕</span> Hide Results
//                       </button>
//                     </div>
