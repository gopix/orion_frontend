...
//                             <span className="rp-summary-value">{reportData.data.summary.issues_attempted}</span>
//                           </div>
//                           <div className="rp-summary-item">
//                             <span className="rp-summary-label">Issues Fixed</span>
//                             <span className="rp-summary-value">{reportData.data.summary.issues_fixed}</span>
//                           </div>
//                           <div className="rp-summary-item">
//                             <span className="rp-summary-label">Issues Failed</span>
//                             <span className="rp-summary-value">{reportData.data.summary.issues_failed}</span>
//                           </div>
//                           <div className="rp-summary-item">
//                             <span className="rp-summary-label">Issues Detected</span>
//                             <span className="rp-summary-value">{reportData.data.summary.issues_detected}</span>
//                           </div>
//                           <div className="rp-summary-item">
//                             <span className="rp-summary-label">Issues Remaining</span>
//                             <span className="rp-summary-value">{reportData.data.summary.issues_remaining}</span>
//                           </div>
//                           <div className="rp-summary-item">
//                             <span className="rp-summary-label">Duration</span>
...
//                             <span className="rp-summary-value">{reportData.data.summary.save_success ? 'Yes' : 'No'}</span>
//                           </div>
//                           {reportData.data.summary.font_encoding && (
//                             <div className="rp-summary-item">
//                               <span className="rp-summary-label">Fonts Patched</span>
//                               <span className="rp-summary-value">{reportData.data.summary.font_encoding.fonts_patched}</span>
//                             </div>
//                           )}
//                         </div>
//                       </div>
