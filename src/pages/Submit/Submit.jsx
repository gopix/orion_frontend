...
//     if (!guidanceDetailCategory || !guidanceDetailForm.guidance.trim()) return;
...
//                   placeholder="Write the plain-English guidance for this book type…"
//                   value={form.guidance}
//                   onChange={(e) => onChangeForm({ ...form, guidance: e.target.value })}
//                 />
//               </div>
//             </div>
//             <div className="bf-form-row">
...
//             className="bf-btn bf-btn-secondary"
//             onClick={onPreview}
//             disabled={loading || previewing || !form.guidance.trim()}
//           >
...
//             className="bf-btn bf-btn-primary"
//             onClick={onSave}
//             disabled={loading || saving || !form.guidance.trim()}
//           >
